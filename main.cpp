...
public:
    ...
    void bookTicket(ServiceProvider ss,Customer cc)
    {
      ...
      if(arr[0]=="A01"||arr[0]=="A02"||arr[0]=="A03")
        ...
        price=200;
      //float price=ss.theatres[id-1].audi[0].seats[index]->getPrice();
      //cout<<price<<endl;
      string nn;
      float sPrice;
      if(id==1){
...
int main()
{
   ...
   // a1.printAudi();
   // a2.printAudi();
   // a3.printAudi();//Just for checking purpose.
   // a4.printAudi();
  ...
  ser.theatres=t_arr;
//t1.snacks=ar;t2.snacks=ar;t3.snacks=ar;t4.snacks=ar;t5.snacks=ar;t6.snacks=ar;t7.snacks=ar;t8.snacks=ar;t9.snacks=ar;
  // t10.snacks=ar;t11.snacks=ar;
   //t1.printSnackss();
   //ser.showTheatreMenu(1);
  int choice;
  while(1)
  {
      cout<<"**********************************************************************************************************************\n";
